<title>The one with the working BACK button</title>
<?php
$carti = array(
...
function afis_carte($array, $key) {
	...
	//end tabel
	echo "</table>";
	echo "<a href=\"{$_SERVER['PHP_SELF']}\">Go back DUDE!</a>";
}
...
function afis_carti($array){
	...
	foreach ($array as $key => $value) {
		...
		echo "<td><a href=\"{$_SERVER['PHP_SELF']}?id=$key\">Detalii</a></td>";
		echo "</tr>";
	}
